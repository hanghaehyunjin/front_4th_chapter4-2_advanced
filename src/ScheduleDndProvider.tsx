...
export default function ScheduleDndProvider({ children }: PropsWithChildren) {
  const { getSchedules, updateScheduleItem } = useScheduleContext();
  ...
  const handleDragEnd = useCallback(
    ...
    (event: any) => {
      ...
      const schedule = schedules[indexNum];
      ...
      updateScheduleItem(tableId, indexNum, updatedSchedule);
    },
    [getSchedules, updateScheduleItem]
  );
